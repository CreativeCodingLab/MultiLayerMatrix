...
public class PopupMenu{
	...
	public static String[] items={"Character View","Group View", "Taxa View"}; 
	
	public PopupMenu(SimilarityMatrix_1_4 parent_){
		parent = parent_;
	}
		...
		if (b>=0){
			...
			for (int i=0;i<items.length;i++){
				if (i==s){
					parent.noStroke();
					parent.fill(0);
					parent.rect(x+7,y+itemH*(i)+3+25,w-15,itemH+1);
				...
				parent.text(items[i],x+14,y+itemH*(i+1)+25);  // 
			}	
		}
		parent.fill(180);
		parent.noStroke();
